...
var Module = typeof EchoCash != "undefined" ? EchoCash : {};
...
(function() {
 ...
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "echocash.data";
  var REMOTE_PACKAGE_BASE = "echocash.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_echocash.data");
   }
   Module["addRunDependency"]("datafile_echocash.data");
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  var pthreadMainJs = locateFile("echocash.worker.js");
...
var proxiedFunctionTable = [ null, _proc_exit, exitOnMainThread, _fd_close, _fd_seek, _fd_write ];
